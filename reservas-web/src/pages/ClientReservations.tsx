        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" 
          ...
          {reservations.map((res: Reservation) => {
            ...
            return (
              <div
                key={res.id}
                className={`bg-[#121214] border border-zinc-800/60 rounded-2xl p-5 flex flex-col justify-between gap-5 relative overflow-hidden transition-all duration-300 shadow-xl ${
                  isInactive ? "opacity-60 grayscale-[10%]" : ""
                }`}
                style={{ 
